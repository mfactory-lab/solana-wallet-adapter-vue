...
const walletAdapterMobile = require("@solana-mobile/wallet-adapter-mobile");
function useAdapterListeners(wallet, unloadingWindow, isUsingMwaOnMobile, deselect, refreshWalletState, handleError) {
  vue.watch(wallet, (newWallet, oldWallet) => {
    ...
    if (oldAdapter.name === walletAdapterMobile.SolanaMobileWalletAdapterWalletName) {
      return;
    }
...
function getEnvironment(adapters, userAgent) {
  const hasInstalledAdapters = adapters.some(
    (adapter) => adapter.name !== walletAdapterMobile.SolanaMobileWalletAdapterWalletName && adapter.readyState === walletAdapterBase.WalletReadyState.Installed
  );
...
function useErrorHandler(unloadingWindow, onError) {
  return (error, adapter) => {
    ...
    if (error instanceof walletAdapterBase.WalletNotReadyError && typeof globalThis !== "undefined" && adapter) {
...
function useMobileWalletAdapters(adapters, isMobile, uriForAppIdentity, cluster) {
  const mobileWalletAdapter = vue.computed(() => {
    if (!isMobile.value) {
      return;
    }
    const existingMobileWalletAdapter = adapters.value.find(
      (adapter) => adapter.name === walletAdapterMobile.SolanaMobileWalletAdapterWalletName
    );
    if (existingMobileWalletAdapter) {
      return existingMobileWalletAdapter;
    }
    return new walletAdapterMobile.SolanaMobileWalletAdapter({
      ...
      chain: cluster.value,
      onWalletNotFound: walletAdapterMobile.createDefaultWalletNotFoundHandler()
    });
  });
  return vue.computed(() => {
...
function useSelectWalletName(localStorageKey, isMobile) {
  const name = useLocalStorage(
    localStorageKey,
    isMobile.value ? walletAdapterMobile.SolanaMobileWalletAdapterWalletName : void 0
  );
  const isUsingMwa = vue.computed(() => name.value === walletAdapterMobile.SolanaMobileWalletAdapterWalletName);
  const isUsingMwaOnMobile = vue.computed(() => isUsingMwa.value && isMobile.value);
...
_StandardWalletAdapter_account = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_publicKey = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_connecting = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_disconnecting = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_off = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_supportedTransactionVersions = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_wallet = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_readyState = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_changed = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_instances = /* @__PURE__ */ new WeakSet(), _StandardWalletAdapter_connect = async function _StandardWalletAdapter_connect2(input) {
  ...
  let publicKey;
  try {
    publicKey = new web3_js.PublicKey(account.address);
  } catch (error) {
  ...
  try {
    ...
    try {
      const signedTransactions = await __classPrivateFieldGet$1(this, _StandardWalletAdapter_wallet, "f").features[SolanaSignTransaction].signTransaction({
        account,
        transaction: walletAdapterBase.isVersionedTransaction(transaction) ? transaction.serialize() : new Uint8Array(transaction.serialize({
          requireAllSignatures: false,
          verifySignatures: false
        }))
      });
      const serializedTransaction = signedTransactions[0].signedTransaction;
      return walletAdapterBase.isVersionedTransaction(transaction) ? web3_js.VersionedTransaction.deserialize(serializedTransaction) : web3_js.Transaction.from(serializedTransaction);
    } catch (error) {
      if (error instanceof walletAdapterBase.WalletError)
        throw error;
  ...
  try {
    ...
    try {
      ...
      return transactions.map((transaction, index2) => {
        ...
        return walletAdapterBase.isVersionedTransaction(transaction) ? web3_js.VersionedTransaction.deserialize(signedTransaction) : web3_js.Transaction.from(signedTransaction);
      });
    } catch (error) {
      throw new walletAdapterBase.WalletSignTransactionError(error == null ? void 0 : error.message, error);
    }
  ...
  try {
    ...
    try {
      ...
      throw new walletAdapterBase.WalletSignInError(error == null ? void 0 : error.message, error);
    }
    if (!output)
      throw new walletAdapterBase.WalletSignInError();
...
function useStandardWalletAdapters(adapters) {
  ...
  const standardAdapters = vue.shallowRef(
...
function wrapWalletsWithAdapters(wallets2) {
  return wallets2.filter((w) => walletAdapterBase.isWalletAdapterCompatibleStandardWallet(w)).map((wallet) => new StandardWalletAdapter({ wallet }));
}
...
function useWalletState(wallets2, name) {
  ...
  const refreshWalletState = () => {
    ...
    readyState.value = ((_c = wallet.value) == null ? void 0 : _c.readyState) ?? walletAdapterBase.WalletReadyState.Unsupported;
  };
  vue.watchEffect(() => {
    ...
    return (_ctx, _cache) => {
      return vue.renderSlot(_ctx.$slots, "default", vue.normalizeProps(vue.guardReactiveProps(scope)), () => [
        vue.createElementVNode("button", {
          ...
          disabled: _ctx.disabled || !vue.unref(wallet) || vue.unref(connecting) || vue.unref(connected),
          onClick
        }, [
          vue.unref(wallet) ? (vue.openBlock(), vue.createBlock(_sfc_main$4, {
            key: 0,
            wallet: vue.unref(wallet)
          }, null, 8, ["wallet"])) : vue.createCommentVNode("", true),
          vue.createElementVNode("span", null, vue.toDisplayString(content.value), 1)
        ], 8, _hoisted_1$3)
      ]);
    };
  }
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.renderSlot(_ctx.$slots, "default", vue.normalizeProps(vue.guardReactiveProps(scope)), () => [
        vue.createElementVNode("button", {
          class: "swv-button swv-button-trigger",
          disabled: _ctx.disabled || vue.unref(disconnecting) || !vue.unref(wallet),
          onClick: handleClick
        }, [
          vue.unref(wallet) ? (vue.openBlock(), vue.createBlock(_sfc_main$4, {
            key: 0,
...
const _sfc_main$1 = vue.defineComponent({
  ...
  setup(properties, { slots }) {
    const { featured, container, logo, dark } = vue.toRefs(properties);
    ...
    const modalPanel = vue.useTemplateRef("modalPanel");
    ...
    const orderedWallets = vue.computed(() => {
      ...
      for (const wallet of wallets2.value) {
        switch (wallet.readyState) {
          case walletAdapterBase.WalletReadyState.NotDetected: {
            notDetected.push(wallet);
            break;
          }
          case walletAdapterBase.WalletReadyState.Loadable: {
            loadable.push(wallet);
            break;
          }
          case walletAdapterBase.WalletReadyState.Installed: {
    ...
    _ctx.modalOpened ? (vue.openBlock(), vue.createBlock(vue.Teleport, {
      ...
      vue.createElementVNode("div", {
        ...
        vue.renderSlot(_ctx.$slots, "overlay", vue.normalizeProps(vue.guardReactiveProps(_ctx.scope)), () => [
          _cache[2] || (_cache[2] = vue.createElementVNode("div", { class: "swv-modal-overlay" }, null, -1))
        ]),
        vue.createElementVNode("div", _hoisted_1$1, [
          vue.renderSlot(_ctx.$slots, "modal", vue.normalizeProps(vue.guardReactiveProps(_ctx.scope)), () => [
            vue.createElementVNode("div", {
              ...
              _ctx.hasLogo ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$1, [
              ...
              _cache[5] || (_cache[5] = vue.createElementVNode("h1", {
                id: "swv-modal-title",
              ...
              vue.createElementVNode("button", {
                ...
                vue.createElementVNode("svg", {
                  ...
                  vue.createElementVNode("path", { d: "M14 12.461 8.3 6.772l5.234-5.233L12.006 0 6.772 5.234 1.54 0 0 1.539l5.234 5.233L0 12.006l1.539 1.528L6.772 8.3l5.69 5.7L14 12.461z" })
                ], -1)
              ])),
                ...
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.walletsToDisplay, (wallet) => {
                  return vue.openBlock(), vue.createElementBlock("li", {
                    ...
                    vue.createElementVNode("button", _hoisted_6, [
                      ...
                      vue.createElementVNode("span", null, vue.toDisplayString(wallet.adapter.name), 1),
                      wallet.readyState === "Installed" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_7, " Detected ")) : vue.createCommentVNode("", true)
                    ])
                  ], 8, _hoisted_5);
                }), 128))
              ]),
              _ctx.hiddenWallets.length > 0 ? (vue.openBlock(), vue.createElementBlock("button", {
                ...
                _cache[4] || (_cache[4] = vue.createElementVNode("i", { class: "swv-button-icon" }, [
                  vue.createElementVNode("svg", {
                    width: "11",
                    height: "6",
                    xmlns: "http://www.w3.org/2000/svg"
                  }, [
                    vue.createElementVNode("path", { d: "m5.938 5.73 4.28-4.126a.915.915 0 0 0 0-1.322 1 1 0 0 0-1.371 0L5.253 3.736 1.659.272a1 1 0 0 0-1.371 0A.93.93 0 0 0 0 .932c0 .246.1.48.288.662l4.28 4.125a.99.99 0 0 0 1.37.01z" })
                  ])
                ], -1))
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const dropdownPanel = vue.useTemplateRef("dropdownPanel");
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(WalletModalProvider, {
        ...
        default: vue.withCtx((modalScope) => [
          vue.renderSlot(_ctx.$slots, "default", vue.normalizeProps(vue.guardReactiveProps({ ...modalScope, ...scope })), () => [
            !vue.unref(wallet) ? (vue.openBlock(), vue.createElementBlock("button", {
              key: 0,
              class: "swv-button swv-button-trigger",
              onClick: modalScope.openModal
            }, " Select Wallet ", 8, _hoisted_1)) : !publicKeyBase58.value ? (vue.openBlock(), vue.createBlock(_sfc_main$3, { key: 1 })) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_2, [
              vue.renderSlot(_ctx.$slots, "dropdown-button", vue.normalizeProps(vue.guardReactiveProps({ ...modalScope, ...scope })), () => [
                vue.createElementVNode("button", {
                  class: "swv-button swv-button-trigger",
                  style: vue.normalizeStyle({ pointerEvents: dropdownOpened.value ? "none" : "auto" }),
                  "aria-expanded": dropdownOpened.value,
                  title: publicKeyBase58.value,
                  onClick: openDropdown
                }, [
                  vue.createVNode(_sfc_main$4, { wallet: vue.unref(wallet) }, null, 8, ["wallet"]),
                  vue.createElementVNode("span", null, vue.toDisplayString(publicKeyTrimmed.value), 1)
                ], 12, _hoisted_3)
              ]),
              vue.renderSlot(_ctx.$slots, "dropdown", vue.normalizeProps(vue.guardReactiveProps({ ...modalScope, ...scope })), () => [
                vue.createElementVNode("ul", {
                  ref_key: "dropdownPanel",
                  ref: dropdownPanel,
                  "aria-label": "dropdown-list",
                  class: vue.normalizeClass(["swv-dropdown-list", { "swv-dropdown-list-active": dropdownOpened.value }]),
                  role: "menu"
                }, [
                  vue.renderSlot(_ctx.$slots, "dropdown-list", vue.normalizeProps(vue.guardReactiveProps({ ...modalScope, ...scope })), () => [
                    vue.unref(canCopy) ? (vue.openBlock(), vue.createElementBlock("li", {
                      key: 0,
                      class: "swv-dropdown-list-item",
                      role: "menuitem",
                      onClick: copyAddress
                    }, vue.toDisplayString(vue.unref(addressCopied) ? "Copied" : "Copy address"), 1)) : vue.createCommentVNode("", true),
        ...
        overlay: vue.withCtx((modalScope) => [
          vue.renderSlot(_ctx.$slots, "modal-overlay", vue.normalizeProps(vue.guardReactiveProps({ ...modalScope, ...scope })))
        ]),
        modal: vue.withCtx((modalScope) => [
          vue.renderSlot(_ctx.$slots, "modal", vue.normalizeProps(vue.guardReactiveProps({ ...modalScope, ...scope })))
        ]),
        _: 3
...
exports.WalletConnectButton = _sfc_main$3;
exports.WalletDisconnectButton = _sfc_main$2;
exports.WalletIcon = _sfc_main$4;
exports.WalletModalProvider = WalletModalProvider;
exports.WalletMultiButton = _sfc_main;
